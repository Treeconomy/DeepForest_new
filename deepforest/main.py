...
import numpy as np
import pandas as pd
from deepforest.new_model import predict
...
from dataset import TreeDataset, TileDataset, get_transform
from new_resnet import create_model_with_weights
from deepforest import  visualize, get_data, utilities
...
class deepforest(pl.LightningModule):
    ...
    def __init__(self,
        ...
        self.model=create_model_with_weights(model_path='/home/nadja/DeepForest_new/deepforest/data/NEON_weights.pkl')
        ...
        if transforms is None:
            self.transforms = get_transform(augment=True)
        else:
    ...
    def use_release(self, check_release=True):
        ...
        if self.config["architecture"] != "retinanet":
            ...
            #self.create_model_with_weights()
    ...
    def predict_tile(self,
        ...
        ds = TileDataset(tile=self.image,
